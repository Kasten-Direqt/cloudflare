...
__export(index_exports, {
  HTTP_MESSAGE_SIGNATURES_DIRECTORY: () => HTTP_MESSAGE_SIGNATURES_DIRECTORY,
  MediaType: () => MediaType,
  RESPONSE_COMPONENTS: () => RESPONSE_COMPONENTS,
  Tag: () => Tag,
  base64: () => base64_exports,
  directoryResponseHeaders: () => directoryResponseHeaders,
  extractHeader: () => extractHeader,
  parseAcceptSignature: () => parseAcceptSignatureHeader,
  signatureHeaders: () => signatureHeaders,
  signatureHeadersSync: () => signatureHeadersSync,
  verify: () => verify
});
